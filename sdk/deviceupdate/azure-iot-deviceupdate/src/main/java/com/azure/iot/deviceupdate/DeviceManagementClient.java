...
public final class DeviceManagementClient {
    ...
    public Response<BinaryData> updateDeviceClassWithResponse(String deviceClassId, BinaryData resource,
        ...
        return this.serviceClient.updateDeviceClassWithResponse(deviceClassId, resource, requestOptions);
    }
    ...
    public Response<BinaryData> createOrUpdateDeploymentWithResponse(String groupId, String deploymentId,
        ...
        return this.serviceClient.createOrUpdateDeploymentWithResponse(groupId, deploymentId, resource, requestOptions);
    }
    ...
    public Response<BinaryData> getLogCollectionWithResponse(String operationId, RequestOptions requestOptions) {
        return this.serviceClient.getLogCollectionWithResponse(operationId, requestOptions);
    }
    ...
    public Response<BinaryData> startLogCollectionWithResponse(String operationId, BinaryData resource,
        RequestOptions requestOptions) {
        return this.serviceClient.startLogCollectionWithResponse(operationId, resource, requestOptions);
    }
    ...
    public Response<BinaryData> getLogCollectionDetailedStatusWithResponse(String operationId,
        RequestOptions requestOptions) {
        return this.serviceClient.getLogCollectionDetailedStatusWithResponse(operationId, requestOptions);
    }
    ...
    public PagedIterable<BinaryData> listHealthOfDevices(RequestOptions requestOptions) {
        return this.serviceClient.listHealthOfDevices(requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public SyncPoller<DeviceOperation, DeviceOperation> beginImportDevices(ImportType importType) {
        // Generated convenience method for beginImportDevicesWithModel
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.beginImportDevicesWithModel(BinaryData.fromObject(importType), requestOptions);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Deployment createOrUpdateDeployment(String groupId, String deploymentId, Deployment resource) {
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeviceClassSubgroupDeployment> listDeploymentsForDeviceClassSubgroup(String groupId,
        ...
        return serviceClient.listDeploymentsForDeviceClassSubgroup(groupId, deviceClassId, requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(DeviceClassSubgroupDeployment.class));
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeviceClassSubgroupDeployment getDeploymentForDeviceClassSubgroup(String groupId, String deviceClassId,
        String deploymentId) {
        ...
        return getDeploymentForDeviceClassSubgroupWithResponse(groupId, deviceClassId, deploymentId, requestOptions)
            .getValue().toObject(DeviceClassSubgroupDeployment.class);
    }
     ...
     * @throws ResourceModifiedException thrown if the request is rejected by server on status code 409.
     * @throws RuntimeException all other wrapped checked exceptions if the request fails to be sent.
     * @return deviceClass Subgroup Deployment metadata.
     */
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeviceClassSubgroupDeployment stopDeployment(String groupId, String deviceClassId, String deploymentId) {
        ...
        return stopDeploymentWithResponse(groupId, deviceClassId, deploymentId, requestOptions).getValue()
            .toObject(DeviceClassSubgroupDeployment.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public DeviceClassSubgroupDeployment retryDeployment(String groupId, String deviceClassId, String deploymentId) {
    ...
    public DeviceClassSubgroupDeploymentStatus getDeviceClassSubgroupDeploymentStatus(String groupId,
        ...
        return getDeviceClassSubgroupDeploymentStatusWithResponse(groupId, deviceClassId, deploymentId, requestOptions)
            .getValue().toObject(DeviceClassSubgroupDeploymentStatus.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogCollection getLogCollection(String operationId) {
        // Generated convenience method for getLogCollectionWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getLogCollectionWithResponse(operationId, requestOptions).getValue().toObject(LogCollection.class);
    }
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogCollection startLogCollection(String operationId, LogCollection resource) {
        // Generated convenience method for startLogCollectionWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return startLogCollectionWithResponse(operationId, BinaryData.fromObject(resource), requestOptions).getValue()
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.SINGLE)
    public LogCollectionOperationDetailedStatus getLogCollectionDetailedStatus(String operationId) {
        // Generated convenience method for getLogCollectionDetailedStatusWithResponse
        RequestOptions requestOptions = new RequestOptions();
        return getLogCollectionDetailedStatusWithResponse(operationId, requestOptions).getValue()
    ...
    public PagedIterable<DeviceHealth> listHealthOfDevices(String filter) {
        ...
        return serviceClient.listHealthOfDevices(requestOptions)
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedIterable<DeviceHealth> listHealthOfDevices() {
        // Generated convenience method for listHealthOfDevices
        RequestOptions requestOptions = new RequestOptions();
        return serviceClient.listHealthOfDevices(requestOptions)
            .mapPage(bodyItemValue -> bodyItemValue.toObject(DeviceHealth.class));
