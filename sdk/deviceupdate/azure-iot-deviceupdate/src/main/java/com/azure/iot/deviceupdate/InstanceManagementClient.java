...
/**
 * Initializes a new instance of the synchronous InstanceManagementClient type.
 */
@ServiceClient(builder = InstanceManagementClientBuilder.class)
public final class InstanceManagementClient {
    @Generated
    private final InstanceManagementClientImpl serviceClient;

    /**
     * Initializes an instance of InstanceManagementClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Generated
    InstanceManagementClient(InstanceManagementClientImpl serviceClient) {
    ...
    public Response<BinaryData> getLimitsWithResponse(RequestOptions requestOptions) {
        return this.serviceClient.getLimitsWithResponse(requestOptions);
    }
    ...
    public Limits getLimits() {
        ...
        return getLimitsWithResponse(requestOptions).getValue().toObject(Limits.class);
    }
}
