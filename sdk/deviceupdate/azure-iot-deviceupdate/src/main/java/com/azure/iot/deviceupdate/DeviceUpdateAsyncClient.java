...
public final class DeviceUpdateAsyncClient {
        ...
        return PagedFlux.create(() -> (continuationToken, pageSize) -> {
            ...
            return flux.map(pagedResponse -> new PagedResponseBase<Void, Update>(pagedResponse.getRequest(),
                pagedResponse.getStatusCode(), pagedResponse.getHeaders(), pagedResponse.getValue().stream()
                    .map(protocolMethodData -> protocolMethodData.toObject(Update.class)).collect(Collectors.toList()),
    ...
    @Generated
    @ServiceMethod(returns = ReturnType.LONG_RUNNING_OPERATION)
    public PollerFlux<UpdateOperation, UpdateOperation> beginImportUpdate(List<ImportUpdateInputItem> updateToImport) {
